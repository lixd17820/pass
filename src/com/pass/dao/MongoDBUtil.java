...
public enum MongoDBUtil {
	...
	static {
		...
		instance.mongoClient = new MongoClient("10.36.6.7", 20000);
	...
	public DB getFsDB(String dbName) {
		if (dbName != null && !"".equals(dbName)) {
	...
	public ListDatabasesIterable<Document> getAllDBInfo() {
		ListDatabasesIterable<Document> s = mongoClient.listDatabases();
		return s;
	}
